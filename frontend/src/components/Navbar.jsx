...
import { Home, Map as MapIcon, PenTool, Target, BookOpen, Layers, BarChart, Shield, Sun, Moon, Flame, Star, Menu, X } from 'lucide-react'
        ...
        <>
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-2">
            <div className="flex items-center gap-4 shrink-0">
              <Link to="/" className="text-2xl font-black bg-gradient-to-r from-primary-400 to-accent-400 bg-clip-text text-transparent flex items-center gap-2">
