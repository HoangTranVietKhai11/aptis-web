  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="text-center py-6">
        <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-primary-300 via-accent-400 to-primary-300 bg-clip-text text-transparent mb-3">
          APTIS B2 Preparation
        </h1>
        <p className="text-primary-300 text-lg">Your personal English exam study platform</p>
      </div>
      ...
      <Link to="/roadmap" className="glass-card p-6 flex flex-col sm:flex-row sm:items-center justify-between group hover:border-primary-400/40 transition-all gap-4">
        <div>
          <h2 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
            <MapIcon className="w-6 h-6 text-accent-400" />
            My Learning Roadmap
          </h2>
          <p className="text-primary-300 text-sm">Follow your A1 → A2 → B1 → B2 path — British Council aligned</p>
        ...
        <div className="flex justify-start sm:justify-end cursor-pointer">
          <ChevronRight className="w-10 h-10 text-white opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
        </div>
      </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="glass-card p-6 flex items-center justify-between group hover:border-primary-400/40 transition-all relative overflow-hidden">
          ...
          <div className="flex items-center gap-5 relative z-10">
            ...
            <div>
              <h3 className="text-sm font-bold text-primary-300 uppercase tracking-widest">Current Rank</h3>
              <p className="text-white font-black text-3xl mb-1">{userStats.level}</p>
              <div className="flex items-center gap-2">
                <div className="px-2 py-0.5 bg-accent-500/20 rounded text-accent-400 text-xs font-bold">{userStats.xp} XP Earned</div>
              </div>
            </div>
          </div>
          <Link to="/leaderboard" className="btn-glow bg-white/5 hover:bg-white/10 text-white px-4 py-2 rounded-lg text-xs font-bold flex items-center gap-2 border border-white/10 relative z-10">
        ...
        <div className="glass-card p-6 flex items-center justify-between group hover:border-orange-500/30 transition-all relative overflow-hidden">
          ...
          <div className="flex items-center gap-5 relative z-10">
            ...
            <div>
              <h3 className="text-sm font-bold text-orange-300/70 uppercase tracking-widest">Study Streak</h3>
              <p className="text-orange-400 font-black text-4xl leading-tight">{userStats.streak} <span className="text-lg font-bold">Days</span></p>
              <p className="text-xs text-orange-200/50 font-medium">Keep it up to level up!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <div className="w-16 h-16 rounded-full bg-red-500/10 text-red-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <Target className="w-8 h-8" />
          </div>
          <h3 className="text-lg font-bold text-white mb-1">Mock Exam</h3>
          <p className="text-sm text-primary-300">Full test simulation</p>
        </Link>
        <Link
          to="/vocabulary"
        ...
        >
          ...
          <h3 className="text-lg font-bold text-white mb-1">Vocabulary</h3>
          <p className="text-sm text-primary-300">Library & Notebook</p>
        </Link>
        <Link
          to="/flashcards"
          className="glass-card p-6 flex flex-col items-center text-center group cursor-pointer border-accent-500/30 bg-accent-600/5 hover:bg-accent-600/10 transition-all"
        >
          <div className="w-16 h-16 rounded-full bg-accent-500/20 text-accent-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <Layers className="w-8 h-8" />
          </div>
          <h3 className="text-lg font-bold text-white mb-1">Flashcards</h3>
          <p className="text-sm text-accent-400 font-medium">SRS Review Ready</p>
        </Link>
      </div>
